...
class ReconocimientoFacial:
    ...
    def capturar_datos_facial():
        ...
        while True:
            ...
            if face_locations:
                # Dibuja un rectángulo alrededor del primer rostro detectado
            ...
            if cv2.waitKey(1) & 0xFF == ord('q'):
                if face_locations:
                    # Obtener el encoding del primer rostro detectado
                    datos_facial = face_recognition.face_encodings(rgb_frame, face_locations)[0]
                else:
                    print("No se detectó ningún rostro al momento de capturar.")
                break
